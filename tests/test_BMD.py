...
class TestBMD_bd(unittest.TestCase):
    ...
    def test_BMD_blockdiagonal_example(self):
        ...
        BMD_model = bmdcluster.BMD(data_clusters = self.C,
...
##
##
###BMD_model = bmdcluster.BMD(data_clusters = C, method = 'block_diagonal', B_ident = True, use_bootstrap = True, b = 5, seed = 1234)
...
##
##
#BMD_model = bmdcluster.BMD(data_clusters = C, method = 'general', B_ident = True, feature_clusters = 3, use_bootstrap = False, b = 5, seed = 1234)
